...
export default function Header({ logo, children, last }: HeaderProps) {
  return (
    <header className="absolute top-0 left-0 flex justify-center w-full z-50 " /* bg-[#fefefe]/60 dark:bg-[#3c3c3c]/60 border-0 border-b-2 border-[#e0e0e0] dark:border-[#2e2e2e] */>
      <div className="transition-colors duration-[50ms] container mx-auto flex justify-between items-center p-3 m-2 my-0">
        <div className="w-full flex justify-start items-center text-slate-50">
